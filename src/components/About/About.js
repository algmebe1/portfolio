    ...
    return (
        <div className="about-container">
            <div className="about-title">
                ...
                <p className="about__introduction">I started my professional career as an engineer. That job allowed to me to develop analytical capacity, Project management and teamwork skills among others.
